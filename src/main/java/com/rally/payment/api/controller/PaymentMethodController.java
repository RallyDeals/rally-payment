...
public class PaymentMethodController {
    ...
    public PaymentMethodListResponse list(@RequestHeader("X-User-Id") UUID userId) {
    ...
    public ResponseEntity<SetupIntentResponse> createSetupIntent(@RequestHeader("X-User-Id") UUID userId) {
    ...
    public PaymentMethodResponse clearDefault(
            @RequestHeader("X-User-Id") UUID userId,
            @PathVariable UUID methodId
    ) {
